...
/** @defgroup XNUCLEO_53L8A1_RANGING_SENSOR_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
int32_t VL53L8A1_RANGING_SENSOR_DeInit(uint32_t Instance)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Drv->DeInit(VL53L8A1_RANGING_SENSOR_CompObj[Instance]) < 0)
  {
...
int32_t VL53L8A1_RANGING_SENSOR_ConfigROI(uint32_t Instance, RANGING_SENSOR_ROIConfig_t *pConfig)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Cap.CustomROI == 0U)
  {
    ret = BSP_ERROR_FEATURE_NOT_SUPPORTED;
  }
  else if (VL53L8A1_RANGING_SENSOR_Drv->ConfigROI(VL53L8A1_RANGING_SENSOR_CompObj[Instance], pConfig) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
...
/**
  ...
  * @retval BSP status
  */
int32_t VL53L8A1_RANGING_SENSOR_ConfigIT(
  uint32_t Instance,
  RANGING_SENSOR_ITConfig_t *pConfig)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Drv->ConfigIT(
             VL53L8A1_RANGING_SENSOR_CompObj[Instance],
             pConfig) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
...
int32_t VL53L8A1_RANGING_SENSOR_SetAddress(uint32_t Instance, uint32_t Address)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Drv->SetAddress(VL53L8A1_RANGING_SENSOR_CompObj[Instance], Address) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
...
int32_t VL53L8A1_RANGING_SENSOR_GetAddress(uint32_t Instance, uint32_t *pAddress)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Drv->GetAddress(VL53L8A1_RANGING_SENSOR_CompObj[Instance], pAddress) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
...
int32_t VL53L8A1_RANGING_SENSOR_SetPowerMode(uint32_t Instance, uint32_t PowerMode)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Drv->SetPowerMode(VL53L8A1_RANGING_SENSOR_CompObj[Instance], (uint8_t)PowerMode) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
...
int32_t VL53L8A1_RANGING_SENSOR_GetPowerMode(uint32_t Instance, uint32_t *pPowerMode)
{
  ...
  else if (VL53L8A1_RANGING_SENSOR_Drv->GetPowerMode(VL53L8A1_RANGING_SENSOR_CompObj[Instance], pPowerMode) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
...
int32_t VL53L8A1_RANGING_SENSOR_XTalkCalibration(uint32_t Instance, uint16_t Reflectance, uint16_t Distance)
{
  ...
  else if (VL53L8CX_XTalkCalibration(VL53L8A1_RANGING_SENSOR_CompObj[Instance], Reflectance, Distance) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
